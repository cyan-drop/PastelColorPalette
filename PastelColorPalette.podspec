#
#  Be sure to run `pod spec lint PastelColorPalette.podspec' to ensure this is a
...
s.description  = "It is a palette that allows users to easily select colors, and palette colors are chosen to be easy to see with texts and graphs.This is useful when the user selects a color, especially when you want to use many colors like labeling."
  ...
  s.homepage     = "https://github.com/cyan-drop/PastelColorPalette"
  ...
  # Or just: s.author    = "cyan-drop"
  # s.authors            = { "cyan-drop" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/cyan-drop/PastelColorPalette.git", :tag => s.version }
  ...
  s.source_files  = "PastelColorPalette/**/*.{h,m}"
